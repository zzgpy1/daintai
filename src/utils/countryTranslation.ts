 ...
 * 获取当前语言下的国家名称
 */
export function getLocalizedCountryName(countryCodeOrName: string, lang: string = 'en'): string {
  ...
  return lang === 'zh' 
    ? countryNamesCN[countryCode] || countryCodeOrName
    : countryNamesEN[countryCode] || countryCodeOrName
}
...
export function getChineseCountryName(countryCodeOrName: string): string {
  return getLocalizedCountryName(countryCodeOrName, 'zh')
}
